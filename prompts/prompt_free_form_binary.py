...
2. Generate three questions that will help you understand how to split the data into two groups. These questions should focus on the descriptions of labels, NOT on the labels themselves.
...
{{
    ...
    "group_1_label": "Answer to the question that defines the first group.", # The answer must not contain labels!
    "group_2_label": "Answer to the question that defines the second group.", # The answer must not contain labels!
