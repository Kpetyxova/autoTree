...
3. Ensure one group in each split contains only the **single most frequent label**.
4. **Score each split** as "bad," "good," or "great," based on its effectiveness in separating the data:
...
Your evaluation should focus on clarity, effectiveness, and adherence to the requirement of having one group contain only the single most frequent label.
"""
